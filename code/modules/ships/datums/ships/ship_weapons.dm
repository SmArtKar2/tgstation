...
/datum/ship_attack/ballistic/shield_buster
	id = "mac-sp"

	hull_damage = 100
	shield_bust = TRUE

/datum/ship_attack/ballistic/homing
	id = "mac-sh"
...
/datum/ship_attack/flame_bomb
	...
	hull_damage = 300 //TODO: add fire damage to NPC ships
	shield_bust = TRUE
...
/datum/ship_attack/ion
	...
	hull_damage = 400 //TODO: and ion damage too
	shield_bust = TRUE
